...
const roleIconMap = {
  ...
  [MemberRole.MODERATOR]: <ShieldCheck className="h-4 w-4 ml-2 text-indogo-500" />,
...
export const ServerMember = ({
  ...
  return (
    <button
      onClick={onClick}
      className={cn('group px-2 py-2 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1', params?.memberId === member.id && 'bg-zinc-700.20 darkLbg-zinc-700')}
    >
